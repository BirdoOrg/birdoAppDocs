...
:::info
    Na [configuração de local de projeto](../configuracao.md#configuração-local-de-projeto) você deve escolher a função "ANIM"!
:::
...
* [***Abrir Cenas***](../funcionalidades/principais/abrir-cena.md): Ferramenta que lista as cenas de Harmony disponíveis no servidor para a etapa de ANIM.
