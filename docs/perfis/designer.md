...
:::info
    Na [configuração de local de projeto](../configuracao.md#configuração-local-de-projeto) você deve escolher a função "DESIGN"!
:::
...
Para o artista de DESIGN essas são ferramentas disponíveis:
