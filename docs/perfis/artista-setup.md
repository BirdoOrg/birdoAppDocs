...
:::info
    Na [configuração de local de projeto](../configuracao.md#configuração-local-de-projeto) você deve escolher a função "SETUP"!
:::
...
Para o artista de setup essas são ferramentas disponíveis:
