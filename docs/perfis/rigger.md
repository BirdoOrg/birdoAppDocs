...
:::info
    Na [configuração de local de projeto](../configuracao.md#configuração-local-de-projeto) você deve escolher a função "RIG"!
:::
...
Para o artista de RIG essas são ferramentas disponíveis:
...
:::tip
    Para fazer uso de nossas Bibliotecas, os Rigs devem seguir uma série de regras em sua estrutura.
    Leia algumas dicas para criação de RIGs usando nossa estrutura [**aqui**](../bibliotecas/rig.md)!
:::
